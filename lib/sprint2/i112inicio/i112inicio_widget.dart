...
import 'i112inicio_model.dart';
export 'i112inicio_model.dart';

class I112inicioWidget extends StatefulWidget {
  const I112inicioWidget({Key? key}) : super(key: key);

  @override
  _I112inicioWidgetState createState() => _I112inicioWidgetState();
}

class _I112inicioWidgetState extends State<I112inicioWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => I112inicioModel());
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'a76mp70h' /* PUBLICAR UNA NUEVA OFERTA */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
