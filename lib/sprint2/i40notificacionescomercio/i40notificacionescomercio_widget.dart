...
import 'i40notificacionescomercio_model.dart';
export 'i40notificacionescomercio_model.dart';
              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(19.0, 17.0, 12.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'bfhfnusi' /* ¡Ahora sos Mega Influencer! */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(19.0, 13.0, 12.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
