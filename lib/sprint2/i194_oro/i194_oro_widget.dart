...
import 'i194_oro_model.dart';
export 'i194_oro_model.dart';

class I194OroWidget extends StatefulWidget {
  const I194OroWidget({Key? key}) : super(key: key);

  @override
  _I194OroWidgetState createState() => _I194OroWidgetState();
}

class _I194OroWidgetState extends State<I194OroWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => I194OroModel());
