...
import 'i168_model.dart';
export 'i168_model.dart';

class I168Widget extends StatefulWidget {
  const I168Widget({Key? key}) : super(key: key);

  @override
  _I168WidgetState createState() => _I168WidgetState();
}

class _I168WidgetState extends State<I168Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => I168Model());
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'gia4ione' /* Lorem ipsum dolor sit amet con... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
