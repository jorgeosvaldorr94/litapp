...
import 'i01_registracion_error_model.dart';
export 'i01_registracion_error_model.dart';

class I01RegistracionErrorWidget extends StatefulWidget {
  const I01RegistracionErrorWidget({Key? key}) : super(key: key);

  @override
  _I01RegistracionErrorWidgetState createState() =>
      _I01RegistracionErrorWidgetState();
}

class _I01RegistracionErrorWidgetState
    extends State<I01RegistracionErrorWidget> {
  late I01RegistracionErrorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => I01RegistracionErrorModel());
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(90.0, 200.0, 91.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        RichText(
