...
import 'i45_eliminar_oferta_model.dart';
export 'i45_eliminar_oferta_model.dart';

class I45EliminarOfertaWidget extends StatefulWidget {
  const I45EliminarOfertaWidget({Key? key}) : super(key: key);

  @override
  _I45EliminarOfertaWidgetState createState() =>
      _I45EliminarOfertaWidgetState();
}

class _I45EliminarOfertaWidgetState extends State<I45EliminarOfertaWidget> {
  late I45EliminarOfertaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => I45EliminarOfertaModel());
  }
