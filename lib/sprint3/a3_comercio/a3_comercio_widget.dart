...
import 'a3_comercio_model.dart';
export 'a3_comercio_model.dart';

class A3ComercioWidget extends StatefulWidget {
  const A3ComercioWidget({Key? key}) : super(key: key);

  @override
  _A3ComercioWidgetState createState() => _A3ComercioWidgetState();
}

class _A3ComercioWidgetState extends State<A3ComercioWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A3ComercioModel());
  }
