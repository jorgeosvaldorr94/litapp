...
import 'i20_esta_no_model.dart';
export 'i20_esta_no_model.dart';

class I20EstaNoWidget extends StatefulWidget {
  const I20EstaNoWidget({Key? key}) : super(key: key);

  @override
  _I20EstaNoWidgetState createState() => _I20EstaNoWidgetState();
}

class _I20EstaNoWidgetState extends State<I20EstaNoWidget>
    with TickerProviderStateMixin {
  late I20EstaNoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => I20EstaNoModel());
  }
                      ...
                      child: StreamBuilder<List<OffersRecord>>(
                        stream: queryOffersRecord(
                          queryBuilder: (offersRecord) =>
                              offersRecord.where('category', isEqualTo: 'Food'),
                        ),
