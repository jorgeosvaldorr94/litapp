...
import 'i7_model.dart';
export 'i7_model.dart';

class I7Widget extends StatefulWidget {
  const I7Widget({Key? key}) : super(key: key);

  @override
  _I7WidgetState createState() => _I7WidgetState();
}

class _I7WidgetState extends State<I7Widget> with TickerProviderStateMixin {
  late I7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => I7Model());
                                  ...
                                  child: Padding(
                                    ...
                                    child: smooth_page_indicator
                                      ...
                                      effect: smooth_page_indicator
                                        ...
                                        activeDotColor: Color(0xFFEA1616),
