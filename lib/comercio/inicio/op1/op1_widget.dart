...
import 'op1_model.dart';
export 'op1_model.dart';

class Op1Widget extends StatefulWidget {
  const Op1Widget({
    Key? key,
  ...
  @override
  _Op1WidgetState createState() => _Op1WidgetState();
}

class _Op1WidgetState extends State<Op1Widget> with TickerProviderStateMixin {
  late Op1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Op1Model());
  }
                                              ...
                                              context.pushNamed(
                                                ...
                                                queryParams: {
                                                  ...
                                                  'descripcion': serializeParam(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '6t9j43r8' /* Beneficios Lorem ipsum dolor s... */,
                                                    ),
                                                    ParamType.String,
                                                  ),
                                                }.withoutNulls,
                                              ...
                                              context.pushNamed(
                                                ...
                                                queryParams: {
                                                  ...
                                                  'descripcion': serializeParam(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'wdkxg72e' /* Beneficios Lorem ipsum dolor s... */,
                                                    ),
                                                    ParamType.String,
                                                  ),
                                                }.withoutNulls,
                                                  ...
                                                  queryParams: {
                                                    ...
                                                    'descripcion':
                                                      ...
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '013teemb' /* Beneficios Lorem ipsum dolor s... */,
                                                      ),
                                                      ParamType.String,
                                                    ),
                                                  }.withoutNulls,
