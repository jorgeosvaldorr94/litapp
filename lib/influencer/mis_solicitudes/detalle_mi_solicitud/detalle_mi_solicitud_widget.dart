...
import 'detalle_mi_solicitud_model.dart';
export 'detalle_mi_solicitud_model.dart';

class DetalleMiSolicitudWidget extends StatefulWidget {
  const DetalleMiSolicitudWidget({
    Key? key,
    this.offer,
  }) : super(key: key);
  ...
  @override
  _DetalleMiSolicitudWidgetState createState() =>
      _DetalleMiSolicitudWidgetState();
}

class _DetalleMiSolicitudWidgetState extends State<DetalleMiSolicitudWidget>
    with TickerProviderStateMixin {
  late DetalleMiSolicitudModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalleMiSolicitudModel());
  }
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'kiytsx5f' /* Dejanos tu reseña en Google!
 */
                                                ,
                                              ),
                                              style:
